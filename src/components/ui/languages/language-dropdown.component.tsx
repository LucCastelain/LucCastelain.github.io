    ...
    return (
        <div>
            <button ref={buttonRef}
                ...
                {language === "ch-zh" ? <Image src="/static/flags/tw.svg" height="24" width="24" className="size-5" alt="中文"/> : null}
            </button>
            <DropdownComponent isOpen={languageDropdown}
                ...
                <DropdownComponent.Item className="px-0">
                    <Link href={`/fr/${params.join("/")}`}
                       className="w-10 items-center flex"><Image src="/static/flags/fr.svg" width="24" height="24" alt="drapeau français" className="mx-auto"/></Link>
                </DropdownComponent.Item>
                <DropdownComponent.Item className="px-0">
                    <Link href={`/en/${params.join("/")}`}
                       className="w-10 items-center flex"><Image src="/static/flags/gb.svg" height="24" width="24" alt="english flag" className="mx-auto"/></Link>
                </DropdownComponent.Item>
                <DropdownComponent.Item className="px-0">
                    <Link href={`/ch-zh/${params.join("/")}`}
                       className="w-10 items-center flex"><Image src="/static/flags/tw.svg" height="24" width="24" alt="中文" className="mx-auto"/></Link>
                </DropdownComponent.Item>
            </DropdownComponent>
        </div>
    );
