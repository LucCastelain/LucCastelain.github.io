    ...
    return (
        <div>
            <button ref={buttonRef}
                ...
                {language === "ch" ? <Image src="/me/static/flags/tw.svg" height="24" width="24" className="size-5" alt="中文"/> : null}
            </button>
            <DropdownComponent isOpen={languageDropdown}
                ...
                <DropdownComponent.Item className="px-0">
                    <a href={`${pathname}?lang=fr`}
                       className="w-10 items-center flex"><Image src="/me/static/flags/fr.svg" width="24" height="24" alt="drapeau français" className="mx-auto"/></a>
                </DropdownComponent.Item>
                <DropdownComponent.Item className="px-0">
                    <a href={`${pathname}?lang=en`}
                       className="w-10 items-center flex"><Image src="/me/static/flags/gb.svg" height="24" width="24" alt="english flag" className="mx-auto"/></a>
                </DropdownComponent.Item>
                <DropdownComponent.Item className="px-0">
                    <a href={`${pathname}?lang=ch`}
                       className="w-10 items-center flex"><Image src="/me/static/flags/tw.svg" height="24" width="24" alt="中文" className="mx-auto"/></a>
                </DropdownComponent.Item>
            </DropdownComponent>
        </div>
    );
