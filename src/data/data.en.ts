...
// ------------------ This website ------------------ //
    ...
    thisWebsite_keypoint1_title: "Made from scratch",
    thisWebsite_keypoint1_description: "",

    thisWebsite_keypoint2_title: "Dark mode",
    thisWebsite_keypoint2_description: "",

    thisWebsite_keypoint3_title: "Multiple languages",
    thisWebsite_keypoint3_description: "This website can be browsed in french, english, and traditional chinese.",
...
// ------------------ Deep Mine ------------------ //
    ...
    deepMine_keypoint6_description: "Creation of textures and sprites as well as the animations for the characters and enemies.",
...
// ------------------ Card game prototype ------------------ //
    ...
    cardGamePrototype_description: "One time, I had an idea of a card game with it own rules. To test if the idea was viable and if the game was balanced, fun and tactical, I made a prototype in Godot game engine.\n\nThe prototype has been made both in 2D and 3D and had a few cards to test the balancing.\nI was made in 2 days from the creation of the rules to the end of prototyping and it was fun to do and test.",

    cardGamePrototype_keypoint1_title: "Creation of the opponent AI",
    cardGamePrototype_keypoint1_description: "The opponent AI can react and play accordingly depending on player's last play.",
...
// ------------------ Genesys Designer ------------------ //
    ...
    genesysDesigner_keypoint1_description: "Dragable and dropable functional blocks, so it really is easy for the users to learn and use.",
...
// ------------------ Global Game Jam 2022 ------------------ //
    ...
    globalGameJam2022_keypoint2_title: "Board game adapted to videogame",
    globalGameJam2022_keypoint2_description: "As a board game, the player movements are handled accordingly and differently compared to a more action focused videogame.",

    globalGameJam2022_keypoint3_title: "Used Github for version control",
    globalGameJam2022_keypoint3_description: "",

    globalGameJam2022_keypoint4_title: "Deck building based gameplay",
...
// ------------------ Global Game Jam 2020 ------------------ //
    ...
    globalGameJam2020_keypoint4_description: "Gameplay is not the same depending on the order you play the levels.",

    globalGameJam2020_keypoint5_title: "Level design",
    globalGameJam2020_keypoint5_description: "Level design is different depending on the level's gameplay (which part of the robot the player get in the said level).",
...
// ------------------ Experiences ------------------ //
    ...
    freelance_summary: "I gave myself 1 year to work as a freelance developer for my self-employed company.\nI have designed and published several games as well as made many prototypes. For each game, I did the pre-production work: game design documents, description of the \"minimum viable product\" and creation of UML diagrams.\nI then programmed the games using Godot game engine.",
