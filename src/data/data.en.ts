...
// ------------------ Stardew Valley like game ------------------ //
    stardewValleyLikeGame_title: "Stardew Valley like game",
    stardewValleyLikeGame_description: "Inspired by Stardew Valley, I made a prototype in Godot engine trying to replicate the farming mechanics of Stardew Valley as well as its inventory.\nI created a slots inventory (as in Minecraft, Terraria, Stardew Valley and a lot of games...) with multiple tabs. I also added a dialogue and trading mechanics, as well as a day/night cycle with a clock.\n\nIt helped me understand better how the Godot Engine works.",

    stardewValleyLikeGame_keypoint1_title: "Interactive world",
    stardewValleyLikeGame_keypoint1_description: "World can be heavily modified. Player can cut vegetation and destroy rocks, he can create fields, plant crops and add objects.",

    stardewValleyLikeGame_keypoint2_title: "NPCs dialogue",
    stardewValleyLikeGame_keypoint2_description: "NPCs can have dialogues with multiple answers that can lead to different quests.",

    stardewValleyLikeGame_keypoint3_title: "Complex inventory system",
    stardewValleyLikeGame_keypoint3_description: "Inventory has multiple tabs for different object types",

    stardewValleyLikeGame_keypoint4_title: "Player customization",
    stardewValleyLikeGame_keypoint4_description: "Player can create their unique player sprite from hair to skin color.",

    stardewValleyLikeGame_keypoint5_title: "Player equipment",
    stardewValleyLikeGame_keypoint5_description: "Player can equip different tools and clothes to change its appearance.",

    stardewValleyLikeGame_keypoint6_title: "Day/Night cycle",
    stardewValleyLikeGame_keypoint6_description: "Clock system that plays crops growth and day/night cycle.",

    stardewValleyLikeGame_keypoint7_title: "Trade system",
    stardewValleyLikeGame_keypoint7_description: "Player can buy and sell items to NPCs. Merchant have their own money purse that refills over time.",

    stardewValleyLikeGame_keypoint8_title: "Local multiplayer",
    stardewValleyLikeGame_keypoint8_description: "Up to 2 players.",
