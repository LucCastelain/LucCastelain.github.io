...
// ------------------ Education ------------------ //
    ...
    engineeringDegree_summary: "工程課程碩士準備班。工程課程涵蓋三大領域：程式設計、電子學與機電一體化。因此，透過這個綜合培訓，我在各個工程領域中建立整體性的理解與全面性的知識，無論任何專業領域都適用。\n專業領域：程式設計",
    engineeringDegree_company: "ENIB",
    engineeringDegree_company_website: "https://www.enib.fr/en_enib/",
    engineeringDegree_location: "布雷斯特（Brest），法國",
    engineeringDegree_startDate: "01-09-2016",
    engineeringDegree_endDate: "01-03-2022",

    erasmusExchange_title: "Erasmus 學期（歐洲交換學位）",
    erasmusExchange_summary: "在挪威的Erasmus學期，我主要研究數據挖掘，機器學習和網頁編程。",
...
// ------------------ Experiences ------------------ //
    ...
    fourMonthsInternship_location: "Centre Européen de Réalité Virtuelle（CERV），布列斯特（Brest），法國（因新冠在法國辦公）",
    fourMonthsInternship_startDate: "01-09-2020",
    fourMonthsInternship_endDate: "21-12-2020",

    engineeringInternship_title: "六個月工程實習",
    engineeringInternship_summary: "我從零開始開發了一個網頁應用程式，讓 QA 團隊能存取自己的腳本，並在測試失敗時填寫原因分析。\n該應用程式在不同分頁中顯示大量資訊，並作為一個起點，將 QA 團隊所有的自動化測試集中在同一個平台上。\n在這段實習期間，我必須每週與 QA 團隊（他們是我的客戶）討論，思考他們的回饋，確保最終產品符合他們的期望。",
