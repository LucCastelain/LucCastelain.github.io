...
// ------------------ Education ------------------ //
    ...
    engineeringDegree_summary: "工程課程的整合準備課程。 工程課程包含三個主要領域:程式，電子和機械學。 謝謝此，我們在所有這些工程領域有全球性的理解和知識，不論是專業。\n專業:程式",
...
// ------------------ Experiences ------------------ //
    ...
    threeMonthsInternship_summary: "我改進和升級了一種工具，它可以在名為'Planet Onco Dose'的醫療軟件中編輯和布置醫療報告。 Planet Onco Dose是一款醫療影像軟件，用于癌症疾病，它處理了大量數據。 使用如此大量數據的優化也是醫療報告工具工作的重要部分。 ",
    ...
    fourMonthsInternship_summary: "我在一個互動模擬系統上工作，旨在幫助早期職業教師學習有效的課堂管理技能。 我必須除和優化使用新軟件，為此系統創建和編輯情景。",
    ...
    engineeringInternship_summary: "應用程式顯示了許多資訊在不同的。 這是從QA獲得所有自動化測試的起點，所有都在同一地方。\n在實習期間，我必須每週與QA團隊討論，以他們為客戶，考慮他們的反，並確保最終產品是他們想要的。",
    ...
    genesys_title: "完全堆的副助理軟件工程師",
    genesys_summary: "我曾擔任副軟件工程師，全職開發Genesys產品。\nGenesys是一家向各類合作伙伴，代理商和客戶管理提供雲端解決方案的公司。\n我曾在網路應用程式上工作，使大企業可以為自己的業務創建自助服務 (互動語音回應) 和輔助服務 (路由) 應用程式。\n我工作的團隊由來自加拿大，美國，印度和歐洲的人組成。",
    ...
    freelance_title: "獨立開發者",
    freelance_summary: "我給自己一年的時間，為我自主公司做獨立開發者。\n我設計和出版了幾款遊戲，並製作了許多原型。每一款遊戲，我都做了前產業工作:遊戲設計文件，\"最低可行的產品\"的描述和UML圖表的製作。\n我使用Godot遊戲引擎編程遊戲。",
    freelance_company: "Luc Castelain",
    freelance_location: "Brest，France",
    freelance_startDate: "01-06-2023",
    freelance_endDate: "01-07-2024",

    baudin_title: "完全堆的軟體工程師",
    baudin_summary: "我曾為巴丁城堡工程師工作。\n巴丁城堡集團是法國建設和土木工程的主要企業之一，擁有2000多名員工。 它在金屬和機械施工，土木工程和建筑業業有超過100年的歷史。\n我的主要工作是將他們的厚度客戶應用程式轉移到網際網路環境。 選擇過渡的應用程式從頭重新設計。 與小團隊合作，我必須參與他們的開發的每一步，從概念到編程，Devops，進入生產和支援。",
