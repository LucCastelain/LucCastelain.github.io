...
// ------------------ Matrix ------------------ //
    ...
    matrix_keypoint5_description: "透過將過濾器設為網址參數，偏好伺服器元件。它也允許分享已設定正確篩選條件的網址，以尋找個人或一群人。",
...
// ------------------ BC Portail ------------------ //
    ...
    bcPortail_keypoint8_description: "所有元件與網頁應用程式皆可使用暗黑模式。",
...
// ------------------ Game engine ------------------ //
    ...
    gameEngine_keypoint2_title: "用引擎製作的基本工作遊戲",
