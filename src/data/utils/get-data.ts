        ...
        experiences: [
            {
                ...
                startDate: new Date(Number(data.highSchool_startDate.split("-")[2]), Number(data.highSchool_startDate.split("-")[1])-1, Number(data.highSchool_startDate.split("-")[0])),
                endDate: new Date(Number(data.highSchool_endDate.split("-")[2]), Number(data.highSchool_endDate.split("-")[1])-1, Number(data.highSchool_endDate.split("-")[0])),
            ...
            },
            {
                ...
                startDate: new Date(Number(data.erasmusExchange_startDate.split("-")[2]), Number(data.erasmusExchange_startDate.split("-")[1])-1, Number(data.erasmusExchange_startDate.split("-")[0])),
                endDate: new Date(Number(data.erasmusExchange_endDate.split("-")[2]), Number(data.erasmusExchange_endDate.split("-")[1])-1, Number(data.erasmusExchange_endDate.split("-")[0])),
                type: resumeType.EDUCATION,
                software: [],
                programmingLanguages: [],
                keypoints: []
            },
            {
                ...
                startDate: new Date(Number(data.engineeringDegree_startDate.split("-")[2]), Number(data.engineeringDegree_startDate.split("-")[1])-1, Number(data.engineeringDegree_startDate.split("-")[0])),
                endDate: new Date(Number(data.engineeringDegree_endDate.split("-")[2]), Number(data.engineeringDegree_endDate.split("-")[1])-1, Number(data.engineeringDegree_endDate.split("-")[0])),
                type: resumeType.EDUCATION,
                software: [],
                programmingLanguages: [],
                keypoints: []
            },
            {
                ...
                startDate: new Date(Number(data.threeMonthsInternship_startDate.split("-")[2]), Number(data.threeMonthsInternship_startDate.split("-")[1])-1, Number(data.threeMonthsInternship_startDate.split("-")[0])),
                endDate: new Date(Number(data.threeMonthsInternship_endDate.split("-")[2]), Number(data.threeMonthsInternship_endDate.split("-")[1])-1, Number(data.threeMonthsInternship_endDate.split("-")[0])),
            ...
            },
            {
                ...
                startDate: new Date(Number(data.fourMonthsInternship_startDate.split("-")[2]), Number(data.fourMonthsInternship_startDate.split("-")[1])-1, Number(data.fourMonthsInternship_startDate.split("-")[0])),
                endDate: new Date(Number(data.fourMonthsInternship_endDate.split("-")[2]), Number(data.fourMonthsInternship_endDate.split("-")[1])-1, Number(data.fourMonthsInternship_endDate.split("-")[0])),
                type: resumeType.EXPERIENCE,
            ...
            },
            {
                ...
                startDate: new Date(Number(data.engineeringInternship_startDate.split("-")[2]), Number(data.engineeringInternship_startDate.split("-")[1])-1, Number(data.engineeringInternship_startDate.split("-")[0])),
                endDate: new Date(Number(data.engineeringInternship_endDate.split("-")[2]), Number(data.engineeringInternship_endDate.split("-")[1])-1, Number(data.engineeringInternship_endDate.split("-")[0])),
                type: resumeType.EXPERIENCE,
            ...
            },
            {
                ...
                startDate: new Date(Number(data.genesys_startDate.split("-")[2]), Number(data.genesys_startDate.split("-")[1])-1, Number(data.genesys_startDate.split("-")[0])),
                endDate: new Date(Number(data.genesys_endDate.split("-")[2]), Number(data.genesys_endDate.split("-")[1])-1, Number(data.genesys_endDate.split("-")[0])),
                type: resumeType.EXPERIENCE,
            ...
            },
            {
                ...
                startDate: new Date(Number(data.freelance_startDate.split("-")[2]), Number(data.freelance_startDate.split("-")[1])-1, Number(data.freelance_startDate.split("-")[0])),
                endDate: new Date(Number(data.freelance_endDate.split("-")[2]), Number(data.freelance_endDate.split("-")[1])-1, Number(data.freelance_endDate.split("-")[0])),
                type: resumeType.EXPERIENCE,
            ...
            },
            {
                ...
                startDate: new Date(Number(data.baudin_startDate.split("-")[2]), Number(data.baudin_startDate.split("-")[1])-1, Number(data.baudin_startDate.split("-")[0])),
                type: resumeType.EXPERIENCE,
